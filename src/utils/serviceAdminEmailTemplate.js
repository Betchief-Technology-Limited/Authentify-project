export const verifiedTemplate = (org) => {
    const name = org?.registeredName || "Your organization";
    ...
    return {
        ...
        `,
        text: `Hi ${cp}, ${name} has been verified by Authentify API Service Provider. You can now subscribe to and use our API services.`
    }
}
...
export const rejectedTemplate = (org, feedback) => {
    ...
    `,
        text: `Hi ${cp}, ${name}'s submission was rejected. ${feedback ? "Reason: " + feedback : ""} Please update and resubmit.`,
    };
};